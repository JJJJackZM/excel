...
public class ExcelApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(ExcelApp.class);

    private final Environment env;

    public ExcelApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ExcelApp.class);
